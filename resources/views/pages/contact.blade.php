        ...
        <div class="container">
            <div class="nav contact-tab-menu" id="nav-contactTab" role="tablist">
                <button class="nav-link active" id="nav-GermanyAddress-tab" data-bs-toggle="tab"
                        ...
                        aria-selected="true"><span class="btn-img"><img src="assets/img/contact/contact-1-1.jpg"
                                                                        alt="contact"></span><span class="btn-title">TechBiz, Germany</span>
                    <span class="btn-text">86 KKL, FrankFrut</span></button>
                <button class="nav-link" id="nav-AustraliaAddress-tab" data-bs-toggle="tab"
                        ...
                        aria-selected="false"><span class="btn-img"><img src="assets/img/contact/contact-1-2.jpg"
                                                                         alt="contact"></span><span class="btn-title">TechBiz, Australia</span>
                    <span class="btn-text">259 NYD, Canberra</span></button>
                <button class="nav-link" id="nav-contact-tab" data-bs-toggle="tab" data-bs-target="#nav-contact"
                        type="button" role="tab" aria-controls="nav-contact" aria-selected="false"><span
                        class="btn-img"><img src="assets/img/contact/contact-1-3.jpg" alt="contact"></span><span
                        class="btn-title">TechBiz, United State</span> <span class="btn-text">259 NYD, NewYork</span>
                </button>
            </div>
                            ...
                            <div class="contact-box"><h3 class="contact-box__title h4">Leave a Message</h3>
                                ...
                                <form class="contact-box__form ajax-contact"
                                    ...
                                    <div class="row gx-20">
                                        ...
                                        <div class="col-md-6 form-group"><input type="email" name="email" id="email"
                                        ...
                                        <div class="col-12 form-group"><textarea name="message" id="message"
